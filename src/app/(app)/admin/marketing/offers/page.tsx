...
import { OfferEditorForm } from '@/components/admin/marketing/OfferEditorForm';
                    ...
                    <TableRow key={o.id}>
                        ...
                        <DropdownMenu>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                <AlertDialogHeaderComponent><AlertDialogTitleComponent>Delete Offer "{o.title}"?</AlertDialogTitleComponent>
                                    <AlertDialogDescription>This will mark the offer for deletion. Save all changes to persist.</AlertDialogDescription>
                                </AlertDialogHeaderComponent>
                                <AlertDialogFooterComponent><AlertDialogCancel>Cancel</AlertDialogCancel><AlertDialogAction onClick={() => handleDeleteOffer(o.id)}>Delete Locally</AlertDialogAction></AlertDialogFooterComponent>
                                </AlertDialogContent>
                            </AlertDialog>
