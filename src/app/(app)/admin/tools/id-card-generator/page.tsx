...
export default function IdCardGeneratorPage() {
  ...
  useEffect(() => {
    if (!isLoadingSettings && generalSettings) {
      form.setValue("companyLogoUrl", generalSettings.companyLogoUrl || "");
      form.setValue("authorizedSignatoryName", generalSettings.idCardDefaultSignatory || "Authorized Signatory");
    }
  ...
  const onSubmit = (values: IdCardFormValues) => {
    const dataForPreview: EmployeeIdCardData = {
      ...
      companyAddress: generalSettings.idCardAddressLine || generalSettings.companyAddress, // Use specific ID card address if available
      idCardReturnInstructions: generalSettings.idCardReturnInstructions,
      idCardPropertyOfLine: generalSettings.idCardPropertyOfLine,
    };
