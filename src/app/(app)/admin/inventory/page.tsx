...
import { ArrowLeft, Archive, PlusCircle, Edit3, Trash2, ListFilter, Loader2, MoreVertical, Save, PackageSearch, Mail, CalendarDays } from "lucide-react"; // Added Mail, CalendarDays
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import { format, parseISO, isValid, startOfDay, endOfDay, subDays, startOfMonth, endOfMonth, startOfYesterday, endOfYesterday } from 'date-fns';
...
export default function InventoryManagementPage() {
  ...
  const uniqueCategories = useMemo(() => ['all', ...new Set(stockItems.map(item => item.category).filter(Boolean).sort())], [stockItems]);
