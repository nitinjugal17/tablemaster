...
import { updateUserRole, updateUserDetails } from '@/app/actions/user-actions';
...
const userEditSchema = z.object({
  ...
  role: z.string(), 
  accountStatus: z.enum(ALL_ACCOUNT_STATUSES as [AccountStatus, ...AccountStatus[]]),
});
  ...
  const fetchUsersData = useCallback(async () => {
    ...
    try {
      ...
      setUsers(fetchedUsers.sort((a, b) => {
        const roleOrder: Record<AppUserRoleType, number> = { superadmin: 0, admin: 1, user: 2 };
        const aRoleOrder = roleOrder[a.role as AppUserRoleType] ?? 3;
        const bRoleOrder = roleOrder[b.role as AppUserRoleType] ?? 3;
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          {!DEFAULT_USER_ROLES.includes(isEditingUser.role) && (
