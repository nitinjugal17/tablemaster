...
const DiscountCard: React.FC<DiscountCardProps> = ({ discount }) => {
  ...
  const formattedValidFrom = discount.validFrom ? format(parseISO(discount.validFrom), 'MMM d, yyyy') : 'N/A';
  const formattedValidTo = discount.validTo ? format(parseISO(discount.validTo), 'MMM d, yyyy') : 'N/A';
  ...
  if (!discount.isActive) validityStatusText = "Inactive";
  else if (discount.validFrom && isFuture(parseISO(discount.validFrom))) validityStatusText = `Starts ${formattedValidFrom}`;
  else if (discount.validTo && isPast(parseISO(discount.validTo))) validityStatusText = `Expired ${formattedValidTo}`;
  else validityStatusText = "Active";
