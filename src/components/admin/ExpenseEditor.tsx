...
const expenseEditorSchemaBase = z.object({
  ...
  category: z.enum(ALL_EXPENSE_CATEGORIES as [ExpenseCategory, ...ExpenseCategory[]], { required_error: "Category is required." }),
  ...
  recurrenceType: z.enum(ALL_RECURRENCE_TYPES as [RecurrenceType, ...RecurrenceType[]]).optional(),
